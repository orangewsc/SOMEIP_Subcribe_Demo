...
char sub[56] = {	0xff, 0xff, 0x81, 0x00, 0x00, 0x00,
...
int main()
{
	...
	if (sendto(SO_Client, sub, 56, 0, (sockaddr *)&Add_Remote, sizeof(Add_Remote)) == SOCKET_ERROR)
	{
		cout << "SO_Client sendto Error = " << WSAGetLastError() << endl;
